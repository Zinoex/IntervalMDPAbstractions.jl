...
function AtomicSparseMatrixCOO{Tv, Ti}(::UndefInitializer, m::Integer, n::Integer) where {Tv, Ti}
    AtomicSparseMatrixCOO(m, n, Ti[], Ti[], Tv[])
end
function AtomicSparseMatrixCOO{Tv}(::UndefInitializer, m::Integer, n::Integer) where {Tv}
    AtomicSparseMatrixCOO{Tv, Int32}(UndefInitializer(), m, n)
end
function AtomicSparseMatrixCOO(::UndefInitializer, m::Integer, n::Integer)
